...
public class Paginations {
    private int pageScale = 10; // 페이지당(데이터) 게시물 수
	private int blockScale = 5; // 블록당 페이지수
	private int currentPage; // 현재 페이지 번호
	private int previousPage; // 이전 페이지
	private int nextPage; // 다음 페이지
	private int totalPage; // 전체 페이지갯수 (75개니까 페이지로는 8페이지(데이터 10개씩이니까))
	private int currentBlock; // 현재 페이지 블록 번호
	private int totalBlock; // 전체 페이지 블록 갯수
	private int pageBegin; // 페이지 내에서의 레코드 시작 번호(123에서 1)
	private int pageEnd; // 페이지 내에서의 레코드 마지막 번호(123에서 3)
